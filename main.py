...
async def webhook():
    try:
        json_update = request.get_json()  # Синхронно!
        update = Update.de_json(json_update, application.bot)  # НЕ await!
        await application.process_update(update)  # await только здесь!
